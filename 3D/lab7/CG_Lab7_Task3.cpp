...
void draw_UI() {
    ...
    if (ImGui::Button("sinx*cosx")) {
        ...
        build_surface(current_func, x0, x1, y0, y1, steps);
    }
    ...
    ImGui::SetCursorPos(ImVec2(1880, 20));
    ImGui::SetNextItemWidth(80);
    if (ImGui::InputInt("x0", &x0)) {
        build_surface(current_func, x0, x1, y0, y1, steps);
    }

    ImGui::SetCursorPos(ImVec2(1880, 42));
    ImGui::SetNextItemWidth(80);
    if (ImGui::InputInt("x1", &x1)) {
        build_surface(current_func, x0, x1, y0, y1, steps);
    }

    ImGui::SetCursorPos(ImVec2(1880, 64));
    ImGui::SetNextItemWidth(80);
    if (ImGui::InputInt("y0", &y0)) {
        build_surface(current_func, x0, x1, y0, y1, steps);
    }

    ImGui::SetCursorPos(ImVec2(1880, 86));
    ImGui::SetNextItemWidth(80);
    if (ImGui::InputInt("y1", &y1)) {
        build_surface(current_func, x0, x1, y0, y1, steps);
    }

    ImGui::SetCursorPos(ImVec2(1880, 108));
    ImGui::SetNextItemWidth(80);
...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(2000, 1000, "3D", NULL, NULL);
    if (!window) {
        glfwTerminate();
        return -1;
    }
    ...
    int y0 = -5;
    int y1 = 5;
    build_surface(current_func, x0, x1, y0, y1, 50);
